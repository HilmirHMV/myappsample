...
function updateBike() {
    ...
    // Input: keyboard lane switching (left/right)
    const dir = inputDir();
    ...
    // Smooth horizontal movement to lane (keyboard only, touch overrides directly)
    if (!touchActive) {
